 ...
 * valgrinded
 *
 * Revision 1.2  2001/06/06 18:34:24  westram
...
AW_window * create_tb_main_window(AW_root *awr) {
	...
	awm->insert_menu_topic(0,"Save Defaults (in ~/.arb_prop/testawt.arb)","D","savedef.hlp",F_ALL, (AW_CB) AW_save_defaults, 0, 0 );
...
AW_window *tb_preset_tree_window( AW_root *root )  {
	...
	aws->create_button(0,"Testdataset");
	aws->at_newline();
