...
symlink_file ../WINDOW/aw_gtk_forward_declarations.hxx INCLUDE/aw_gtk_forward_declarations.hxx &&
symlink_file ../WINDOW/aw_gtk_migration_helpers.hxx INCLUDE/aw_gtk_migration_helpers.hxx &&
symlink_file ../WINDOW/aw_help.hxx INCLUDE/aw_help.hxx &&
...
symlink_file ../WINDOW/aw_xfig.hxx INCLUDE/aw_xfig.hxx &&
symlink_file ../WINDOW/aw_zoomable.hxx INCLUDE/aw_zoomable.hxx  &&
