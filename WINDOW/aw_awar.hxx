...
public:
    ...
    AW_awar *add_callback(Awar_CB2 f, AW_CL cd1, AW_CL cd2)     __ATTR__DEPRECATED_CALLBACK_LATER;
    AW_awar *add_callback(Awar_CB1 f, AW_CL cd1)                __ATTR__DEPRECATED_CALLBACK_LATER;
    AW_awar *add_callback(Awar_CB0 f);
    AW_awar *add_callback(const RootCallback& cb);

    AW_awar *remove_callback(Awar_CB2 f, AW_CL cd1, AW_CL cd2)  __ATTR__DEPRECATED_CALLBACK_LATER;
    AW_awar *remove_callback(Awar_CB1 f, AW_CL cd1)             __ATTR__DEPRECATED_CALLBACK_LATER;
