...
AW_window *MG_merge_extendeds_cb(AW_root *awr) {
    ...
    aws->at("ex1");
    awt_create_selection_list_on_extendeds(GLOBAL_gb_src, (AW_window *)aws, AWAR_EX_NAME_SRC);
    ...
    aws->at("ex2");
    awt_create_selection_list_on_extendeds(GLOBAL_gb_dst, (AW_window *)aws, AWAR_EX_NAME_DST);
