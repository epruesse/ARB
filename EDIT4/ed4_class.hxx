...
class ED4_cursor
{
    ED4_index		abs_x;			// absolute (to terminal) x-position of cursor (absolute world coordinate of edit window)
...
public:
    ...
    long		get_abs_x() const	{ return abs_x; }
    void 		set_abs_x();
...
//    unsigned int		has_callback:1;
    ...
    virtual ED4_returncode  	adjust_clipping_rectangle(void);
    virtual short		calc_bounding_box(void);
    virtual ED4_returncode	calc_size_requested_by_parent( void );
...
public:
    ...
    ED4_manager			*main_manager;	// Points to Main manager of ED4
...
//    ED4_returncode	resize_all_windows( void );
    ...
    ED4_returncode	add_to_selected( class ED4_terminal *object );
    ED4_returncode	remove_from_selected( class ED4_terminal *object);
    short               is_primary_selection( class ED4_terminal *object);
...
extern void 	ED4_create_awars		(AW_root *root, const char *config_name);
