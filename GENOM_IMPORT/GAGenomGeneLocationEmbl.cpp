...
bool gellisary::GAGenomGeneLocationEmbl::isReference()
{
    if(!prepared)
    {
        parse();
...
void gellisary::GAGenomGeneLocationEmbl::setReference(string * new_reference)
{
    reference = *new_reference;
}

string * gellisary::GAGenomGeneLocationEmbl::getReference()
{
    if(!prepared)
    {
        parse();
...
bool gellisary::GAGenomGeneLocationEmbl::hasMoreValues()
{
    if(!prepared)
    {
        parse();
...
vector<string> gellisary::GAGenomGeneLocationEmbl::getParts(string * beginning, int * indecies)
{
