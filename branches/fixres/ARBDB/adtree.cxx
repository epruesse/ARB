...
static void STATICTEST_downcast() { // no need to run
    ...
    typedef  ARB_type_traits::remove_cv<DERIVED>::type NCV_DERIVED;
    typedef  ARB_type_traits::remove_cv<FURTHER>::type NCV_FURTHER;

    typedef  ARB_type_traits::remove_cv<CONST_BASE   >::type NCV_CONST_BASE;
    typedef  ARB_type_traits::remove_cv<CONST_DERIVED>::type NCV_CONST_DERIVED;
    typedef  ARB_type_traits::remove_cv<CONST_FURTHER>::type NCV_CONST_FURTHER;
    ...
    STATIC_ASSERT((is_base_of<DERIVED, DERIVED>::value == false));
    STATIC_ASSERT((is_base_of<FURTHER, FURTHER>::value == false));
    ...
    STATIC_ASSERT((is_base_of<NCV_CONST_FURTHER, FURTHER>::value == false));

    // check base classes are detected
    STATIC_ASSERT((is_base_of<BASE, DERIVED>::value    == true));
    STATIC_ASSERT((is_base_of<BASE, FURTHER>::value    == true));
    STATIC_ASSERT((is_base_of<DERIVED, FURTHER>::value == true));

    STATIC_ASSERT((is_base_of<CONST_BASE, DERIVED>::value    == true));
    ...
    STATIC_ASSERT((is_base_of<FURTHER, BASE>::value    == false));
    STATIC_ASSERT((is_base_of<FURTHER, DERIVED>::value == false));

    STATIC_ASSERT((is_base_of<CONST_DERIVED, BASE>::value    == false));
    STATIC_ASSERT((is_base_of<CONST_FURTHER, BASE>::value    == false));
    STATIC_ASSERT((is_base_of<CONST_FURTHER, DERIVED>::value == false));

    STATIC_ASSERT((is_base_of<DERIVED, CONST_BASE>::value    == false));
    STATIC_ASSERT((is_base_of<FURTHER, CONST_BASE>::value    == false));
    STATIC_ASSERT((is_base_of<FURTHER, CONST_DERIVED>::value == false));
    ...
    STATIC_ASSERT((is_same<FURTHER, CONST_FURTHER>::value == false));


    STATIC_ASSERT((is_same<NCV_BASE, NCV_BASE>::value       == true));
    STATIC_ASSERT((is_same<NCV_DERIVED, NCV_DERIVED>::value == true));
    STATIC_ASSERT((is_same<NCV_FURTHER, NCV_FURTHER>::value == true));

    STATIC_ASSERT((is_same<NCV_CONST_BASE, NCV_BASE>::value       == true));
    STATIC_ASSERT((is_same<NCV_CONST_DERIVED, NCV_DERIVED>::value == true));
    STATIC_ASSERT((is_same<NCV_CONST_FURTHER, NCV_FURTHER>::value == true));

    STATIC_ASSERT((is_same<NCV_BASE, NCV_CONST_BASE>::value       == true));
    STATIC_ASSERT((is_same<NCV_DERIVED, NCV_CONST_DERIVED>::value == true));
    ...
    STATIC_ASSERT((is_same<CONST_FURTHER, DERIVED>::value == false));

    STATIC_ASSERT((is_same<BASE, CONST_DERIVED>::value    == false));
    STATIC_ASSERT((is_same<BASE, CONST_FURTHER>::value    == false));
    STATIC_ASSERT((is_same<DERIVED, CONST_FURTHER>::value == false));

    STATIC_ASSERT((is_same<DERIVED, CONST_BASE>::value    == false));
    STATIC_ASSERT((is_same<FURTHER, CONST_BASE>::value    == false));
    ...
    STATIC_ASSERT((is_same<NCV_FURTHER, NCV_CONST_DERIVED>::value == false));
}
