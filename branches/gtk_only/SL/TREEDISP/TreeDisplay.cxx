...
public:
    ...
    void test_print_tree(AW_device_print *print_device, const char* file, AP_tree_display_type type, bool show_handles) {
...
#else
        for (AP_tree_display_type type = AP_tree_display_type(AP_LIST_SIMPLE-1); type >= AP_TREE_NORMAL; type = AP_tree_display_type(type-1)) {
#endif
