...
void TEST_SLOW_design_probes_and_load_result() {
    ...
    char *saved_design_result = NULL; // content of that file
    {
        ...
        TEST_EXPECT_EQUAL__BROKEN(saved_design_result, recent_probeDesignSave); // see comment in TEST_LATE_recent_probe_design_result
    }

    TEST_EXPECT_LOADS_INTO_MULTIPROBE_AS__BROKEN(saved_design_result, recent_expected);
