...
void TEST_SLOW_match_probe() {
    ...
    }
    {
        ...
        CCP expectd2 = "    name---- fullname mis N_mis wmis pos ecoli rev          'UCACCUCCUUUCU'\1"
            "BcSSSS00\1" "  BcSSSS00            0     0  0.0 175   161 0   GCGGCUGGA-=============-\1"
            "PbcAcet2\1" "  PbcAcet2            0     2  0.0 175   161 0   GCGGCUGGA-===========NN-\1"
            "PbrPropi\1" "  PbrPropi            0     2  0.0 175   161 0   GCGGCUGGA-===========NN-\1"
        ...
        CCP expectd3 = "    name---- fullname mis N_mis wmis pos ecoli rev          'UCACCUCCUUUCU'\1"
            ...
            "PbcAcet2\1" "  PbcAcet2            0     2  0.0 175   161 0   GCGGCUGGA-===========NN-\1"
            "PbrPropi\1" "  PbrPropi            0     2  0.0 175   161 0   GCGGCUGGA-===========NN-\1"
            "DlcTolu2\1" "  DlcTolu2            0     3  0.0 175   161 0   GCGGCUGGA-==========NNN-\1"
            "AclPleur\1" "  AclPleur            1     2  1.1 175   161 0   GCGGUUGGA-==========A..-\1"
            "PtVVVulg\1" "  PtVVVulg            1     2  1.1 175   161 0   GCGGUUGGA-==========A..-\1"
            "ClfPerfr\1" "  ClfPerfr            2     0  2.2 175   161 0   AAGAUUAAU-A=C==========-\1";
...
void TEST_SLOW_unmatched_probes() {
    ...
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAG",          "AAUUGAAGAGUUUGAUCAAG");
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAGU",         "AUUGAAGAGUUUGAUCAAGU");
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAGUC",        "UUGAAGAGUUUGAUCAAGUC");
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAGUCG",       "UGAAGAGUUUGAUCAAGUCG");
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAGUCGA",      "GAAGAGUUUGAUCAAGUCGA");
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAGUCGAG",     "AAGAGUUUGAUCAAGUCGAG");
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAGUCGAGC",    "AGAGUUUGAUCAAGUCGAGC");
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAGUCGAGCG",   "GAGUUUGAUCAAGUCGAGCG");
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAGUCGAGCGG",  "AGUUUGAUCAAGUCGAGCGG");
    TEST_PARTIAL_COVERS_FULL_PROBE__BROKEN("UUUGAUCAAGUCGAGCGGU", "GUUUGAUCAAGUCGAGCGGU");
}
