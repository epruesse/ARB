...
AW_window *NT_create_resort_window(AW_root *awr) {
    ...
    create_selection_list_on_itemfields(GLOBAL.gb_main, aws, AWAR_TREE_SORT1, NT_RESORT_FILTER, "key1", 0, SPECIES_get_selector(), 20, 10);
    create_selection_list_on_itemfields(GLOBAL.gb_main, aws, AWAR_TREE_SORT2, NT_RESORT_FILTER, "key2", 0, SPECIES_get_selector(), 20, 10);
    create_selection_list_on_itemfields(GLOBAL.gb_main, aws, AWAR_TREE_SORT3, NT_RESORT_FILTER, "key3", 0, SPECIES_get_selector(), 20, 10);
