...
void AW_preset_create_color_chooser(AW_window *aws, const char *awar, const char *label,int message_reload)
{
    ...
    aws->create_button("SELECT A COLOR","S");
}
...
AW_gc_manager AW_manage_GC(AW_window *aww,
    ...
    for (id = background; id; id=va_arg(parg,char *)){ // "-background$#3be"
        ...
        //         if (first) {
        //             awar_background_name = strdup(awar_name);
            
        //             fprintf(stderr, "%s=%s\n", awar_name, aw_root->awar_string(awar_name)->read_string());
        //         }
        
        //         if (!first) {
        //             aw_root->awar_string(awar_name,"yellow",aw_def);
        //         }else{
        //             aw_root->awar_string(awar_name,"navy",aw_def);
        //         }
    ...
    //     if (awar_background_name) {
    //         char *content = aw_root->awar(awar_background_name)->read_string();
    //         fprintf(stderr, "content='%s'\n", content);
        
//         AW_awar *awar = aw_root->awar(awar_background_name);
//         awar->write_string("#000");
//         awar->write_string("#f00"); // rot zum testen @@@
        
//         free(awar_background_name);
//     }
        ...
        if (!flag_no_fonts) {
            ...
            aws->create_option_menu(awar_name, "Font", 0);{
                ...
                for (font_nr = 0;; font_nr++) {
                    ...
                    if (flag_fixed_fonts_only && aw_root->font_2_xfig((AW_font) font_nr) >= 0)
                        continue;
