...
XS(XS_ARB_find)
{
    dXSARGS;
    if (items != 4)
	croak("Usage: ARB::find(gbd,key,str,search_mode)");
    {
	GBDATA *	gbd;
...
XS(XS_ARB_search)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: ARB::search(gbd,str,type_of_entry)");
    {
	GBDATA *	gbd;
...
XS(XS_ARB_create)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: ARB::create(father,key,type)");
    {
	GBDATA *	father;
	char *	key = (char *)SvPV(ST(1),PL_na);
...
XS(XS_ARB_first_marked)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: ARB::first_marked(gbd,keystring)");
    {
	GBDATA *	gbd;
...
XS(XS_ARB_next_marked)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: ARB::next_marked(gbd,keystring)");
    {
	GBDATA *	gbd;
	char *	keystring = (char *)SvPV(ST(1),PL_na);
	GBDATA *	RETVAL;
...
XS(XS_ARB_read_string)
{
    dXSARGS;
    if (items != 1)
	croak("Usage: ARB::read_string(gbd)");
    {
	GBDATA *	gbd;
	char *	RETVAL;
...
XS(XS_ARB_read_bits)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: ARB::read_bits(gbd,c_0,c_1)");
    {
	GBDATA *	gbd;
...
XS(XS_ARB_read_bytes)
{
    dXSARGS;
    if (items != 1)
	croak("Usage: ARB::read_bytes(gbd)");
    {
	GBDATA *	gbd;
	char *	RETVAL;
...
XS(XS_ARB_read_ints_using_index)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: ARB::read_ints_using_index(gbd,index)");
    {
	GBDATA *	gbd;
...
XS(XS_ARB_read_floats_using_index)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: ARB::read_floats_using_index(gbd,index)");
    {
	GBDATA *	gbd;
	int	index = (int)SvIV(ST(1));
	double	RETVAL;
...
XS(XS_ARB_write_ints_using_index)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: ARB::write_ints_using_index(gbd,val,index)");
    {
	GBDATA *	gbd;
...
XS(XS_ARB_write_floats_using_index)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: ARB::write_floats_using_index(gbd,f,index)");
    {
	GBDATA *	gbd;
...
XS(XS_ARB_add_callback)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: ARB::add_callback(gbd,func_name,clientdata)");
    {
	GBDATA *	gbd;
...
XS(XS_ARB_ensure_callback)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: ARB::ensure_callback(gbd,func_name,clientdata)");
    {
	GBDATA *	gbd;
	char *	func_name = (char *)SvPV(ST(1),PL_na);
	char *	clientdata = (char *)SvPV(ST(2),PL_na);
...
XS(XS_ARB_remove_callback)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: ARB::remove_callback(gbd,func_name,clientdata)");
    {
	GBDATA *	gbd;
	char *	func_name = (char *)SvPV(ST(1),PL_na);
	char *	clientdata = (char *)SvPV(ST(2),PL_na);
...
XS(XS_ARB_request_undo_type)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: ARB::request_undo_type(gb_main,type)");
    {
	GBDATA *	gb_main;
...
XS(XS_ARB_undo)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: ARB::undo(gb_main,type)");
    {
	GBDATA *	gb_main;
	char *	type = (char *)SvPV(ST(1),PL_na);
	char *	RETVAL;
...
XS(XS_ARB_undo_info)
{
    dXSARGS;
    if (items != 2)
	croak("Usage: ARB::undo_info(gb_main,type)");
    {
	GBDATA *	gb_main;
	char *	type = (char *)SvPV(ST(1),PL_na);
	char *	RETVAL;
...
XS(XS_ARB_get_requested_undo_type)
{
    dXSARGS;
    if (items != 1)
	croak("Usage: ARB::get_requested_undo_type(gb_main)");
    {
	GBDATA *	gb_main;
	char *	RETVAL;
...
XS(XS_ARB_P2AT_open_table_field)
{
    dXSARGS;
    if (items != 3)
	croak("Usage: ARB::P2AT_open_table_field(gb_table,key,type)");
    {
	GBDATA *	gb_table;
	char *	key = (char *)SvPV(ST(1),PL_na);
	char *	type = (char *)SvPV(ST(2),PL_na);
