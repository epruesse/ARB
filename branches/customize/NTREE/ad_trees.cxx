...
void create_trees_var(AW_root *aw_root, AW_default aw_def) {
    ...
    AW_create_fileselection_awars(aw_root, AWAR_TREE_EXPORT_FILEBASE, "", ".tree", "treefile", true);
    ...
    AW_create_fileselection_awars(aw_root, AWAR_TREE_IMPORT, "", ".tree", "treefile", true);
