    ...
    while (in.getLine(lineStr)) {
        ...
        if (in_line[0] == '#' || (in_line[0] && in_line[1] == '#')) {
            ...
            if (strcmp(head, "menu") == 0) { 
                ...
                if (thismenu == NULL) throwParseError("'menumask' used w/o 'menu'", in);
            ...
            // itemmethod: generic command line generated by this item
                ...
                if (thisitem == NULL) throwParseError("'itemmethod' used w/o 'item'", in);
             ...
             */
                ...
                if (thisitem == NULL) throwParseError("'arg' used w/o 'item'", in);
            ...
            // argtype: Defines the type of argument (menu,chooser, text, slider)
                ...
                if (thisarg == NULL) throwParseError("'argtype' used w/o 'arg'", in);
                int arglen = -1;
             ...
             */
                ...
                if (thisarg == NULL) throwParseError("'argtext' used w/o 'arg'", in);
             ...
             */
                ...
                if (thisarg == NULL) throwParseError("'arglabel' used w/o 'arg'", in);
             ...
             */
                ...
                if (thisarg == NULL) throwParseError("'argchoice' used w/o 'arg'", in);
            ...
            // argmin: Minimum value for a slider
                ...
                if (thisarg == NULL) throwParseError("'argmin' used w/o 'arg'", in);
                (void)sscanf(temp, "%lf", &(thisarg->min));
            }
            // argmax: Maximum value for a slider
            else if (strcmp(head, "argmax") == 0) {
                if (thisarg == NULL) throwParseError("'argmax' used w/o 'arg'", in);
             ...
             */
                ...
                if (thisarg == NULL) throwParseError("'argmethod' used w/o 'arg'", in);
            ...
            // argvalue: default value for a slider
                ...
                if (thisarg == NULL) throwParseError("'argvalue' used w/o 'arg'", in);
            ...
            // argoptional: Flag specifying that an argument is optional
                ...
                if (thisarg == NULL) throwParseError("'argoptional' used w/o 'arg'", in);
                thisarg->optional = TRUE;
            }
            else if (strcmp(head, "argmask") == 0) {
                if (thisarg == NULL) throwParseError("'argmask' used w/o 'arg'", in);
                if (strcmp("expert", temp) == 0) thisarg->active_mask = AWM_EXP;
            }
            // in: Input file description
            else if (strcmp(head, "in") == 0) {
                if (thisitem == NULL) throwParseError("'in' used w/o 'item'", in);
            ...
            // out: Output file description
                ...
                if (thisitem == NULL) throwParseError("'out' used w/o 'item'", in);
