...
AW_window *create_save_box_for_selection_lists(AW_root *aw_root, AW_CL cl_storabsellist) {
    ...
    char *awar_line_anz = get_shared_sellist_awar_name(typedsellist, "line_anz");
    {
        ...
        AW_create_fileselection_awars(aw_root, awar_base, ".", storabsellist->get_filter(), def_name, true);
        free(def_name);
...
AW_window *create_load_box_for_selection_lists(AW_root *aw_root, AW_CL cl_storabsellist) {
    ...
    AW_create_fileselection_awars(aw_root, awar_base_name, ".", storabsellist->get_filter(), "", true);
                               ...
                               const char *close_button_text)
{
    ...
    AW_create_fileselection_awars(aw_root, base_name, default_directory, file_extension, "", true);
