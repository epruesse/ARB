...
#undef cb
    ...
    // awars to save/load search parameters:
    {
        ...
        AW_create_fileselection_awars(root, ED4_SEARCH_SAVE_BASE, dir, ".asp", "noname.asp", false);
            ...
            if (pattern==ED4_ANY_PATTERN || settings[pattern]->get_open_folded() || !terminal->is_in_folded_group()) {
                ...
                if (found) {
                    ...
                    if (terminal==start_terminal && pos==start_pos) {
                        ...
                        seq_terminal->setCursorTo(&current_cursor(), pos, true, ED4_JUMP_KEEP_POSITION);
                    }
                    break;
                }
                else if (last_loop) {
