...
static AW_window *popup_new_main_window(AW_root *awr, int clone) {
    ...
    if (clone) {
        ...
        awm->create_menu("Probes", "P", AWM_ALL);
        {
            ...
            awm->insert_menu_topic("probe_match_cont", "Match Display Control",         "l", "probespec.hlp", AWM_ALL, makeCreateWindowCallback(create_probe_match_specificity_control_window, ntw));
            awm->sep______________();
