...
ArbProbeMatchWeighting::ArbProbeMatchWeighting(const double aValues[16],
                                               double dWidth,
                                               double dBias)
 : ArbRefCount(),
   PenaltyMatrix()
...
void ArbProbeMatchWeighting::initialise(const double aValues[16],
                                        double dWidth,
                                        double dBias)
{
  Width = dWidth;
...
bool elementHasName(DOMElement* pElement,
                    const char* pName)
{
  bool bHasName = false;
...
void ArbProbeCollection::setParameters(const double aValues[16],
                                       double dWidth,
                                       double dBias)
{
...
void ArbProbeCollection::getParameters(double aValues[16],
                                       double& dWidth,
                                       double& dBias) const
{
...
int ArbMatchResultsManager::enumerateResults(ArbMatchResultsEnumCallback pCallback,
                                             void* pContext,
                                             bool& bAborted)
{
  int nResults = 0;
