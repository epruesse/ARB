...
void TEST_SLOW_variable_defaults_in_server() {
    ...
    {
        char *socketname = GBS_global_string_copy(":%s", GB_path_in_ARBHOME("UNIT_TESTER/sockets/ptserver.socket"));
        TEST_ASSERT_EQUAL(servername, socketname); // as defined in ../lib/arb_tcp.dat@ARB_TEST_PT_SERVER
        free(socketname);
    }
