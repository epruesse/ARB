...
static const char *AP_probe_pt_look_for_server(ARB_ERROR& error) {
    ...
    error = arb_look_and_start_ptserver(AISC_MAGIC_NUMBER, server_tag, false);
...
void TEST_SLOW_variable_defaults_in_server() {
    ...
    TEST_ASSERT_NO_ERROR(arb_look_and_start_ptserver(AISC_MAGIC_NUMBER, server_tag, false));
