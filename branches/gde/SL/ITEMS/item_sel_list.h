...
CONSTEXPR long FIELD_FILTER_FLOAT_WRITEABLE  = FIELD_FILTER_STRING_WRITEABLE | (1<<GB_FLOAT);
CONSTEXPR long FIELD_FILTER_INT_WRITEABLE    = FIELD_FILTER_FLOAT_WRITEABLE  | (1<<GB_INT);
CONSTEXPR long FIELD_FILTER_BYTE_WRITEABLE   = FIELD_FILTER_INT_WRITEABLE    | (1<<GB_BYTE);
