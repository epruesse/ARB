...
AW_window *STAT_create_chimera_check_window(AW_root *root, GBDATA *gb_main) {
    ...
    if (!aws) {
        ...
        create_selection_list_on_itemfields(gb_main, aws, ST_ML_AWAR_CQ_DEST_FIELD, true, SPECIES_get_selector(), 1 << GB_STRING, SF_STANDARD, "dest", 20, 10, "SELECT_REPORT_FIELD"); // @@@ use FIELD_FILTER_STRING_WRITEABLE?
