...
AW_window *NT_create_compare_taxonomy_window(AW_root *aw_root, AWT_canvas *ntw) {
    ...
    create_selection_list_on_itemfields(ntw->gb_main, aws, AWAR_TREE_COMPARE_WRITE_FIELD, true, SPECIES_get_selector(), 1<<GB_INT, SF_STANDARD, "field", 20, 30, "choose_field"); // @@@ use FIELD_FILTER_INT_WRITEABLE? needs code fix
