...
AW_window *NT_create_species_join_window(AW_root *root) {
    ...
    if (!aws) {
        ...
        create_selection_list_on_itemfields(GLOBAL.gb_main, aws, AWAR_SPECIES_JOIN_FIELD, true, SPECIES_get_selector(), FIELD_FILTER_NDS, SF_STANDARD, "field", 0, 20, 10, NULL);
    }
    return aws;
}
