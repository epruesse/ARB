...
static AW_window *createMergeSimilarSpeciesWindow(AW_root *aw_root, MergeSpeciesType mergeType, AW_selection *selected_alis) {
    ...
    create_selection_list_on_itemfields(GLOBAL.gb_main, aws, AWAR_CON_MERGE_FIELD, true, SPECIES_get_selector(), FIELD_FILTER_NDS, SF_HIDDEN, "field_select", 20, 30, "sel_merge_field");
