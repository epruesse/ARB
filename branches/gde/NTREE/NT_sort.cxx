...
AW_window *NT_create_resort_window(AW_root *awr) {
    ...
    create_selection_list_on_itemfields(GLOBAL.gb_main, aws, AWAR_TREE_SORT1, SPECIES_get_selector(), FIELD_FILTER_RESORT, SF_STANDARD, "key1", "sel_k1");
    create_selection_list_on_itemfields(GLOBAL.gb_main, aws, AWAR_TREE_SORT2, SPECIES_get_selector(), FIELD_FILTER_RESORT, SF_STANDARD, "key2", "sel_k2");
    create_selection_list_on_itemfields(GLOBAL.gb_main, aws, AWAR_TREE_SORT3, SPECIES_get_selector(), FIELD_FILTER_RESORT, SF_STANDARD, "key3", "sel_k3");
