...
inline long GB_UNCOMPRESSED_SIZE(GBENTRY *gbe, GB_TYPES type) { // @@@ gbe contains type (check caller situation)
    return GB_GETSIZE(gbe) * gb_convert_type_2_sizeof[type] + gb_convert_type_2_appendix_size[type];
}
