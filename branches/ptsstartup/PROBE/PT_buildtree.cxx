...
void TEST_Partition() {
...

    {
        ...
        TEST_EXPECT_EQUAL(P16.estimate_max_kb_for_any_pass(BASES_100k), 389427);
    }

    {
        ...
        TEST_EXPECT_EQUAL(P13.estimate_max_kb_for_any_pass(BASES_100k), 389531);
    }

    {
        ...
        TEST_EXPECT_EQUAL(P12.estimate_max_kb_for_any_pass(BASES_100k), 389523);
    }
...
void TEST_SLOW_decide_passes_to_use() {
    ...
    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, MEM1,           1,    0, 3593147643UL,  22846293,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, MEM2,           2,    1, 1858375961,    14883962,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, MEM3,           5,    4,  723822949,     9676541,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, MEM4,         194,    4,   32084148,     6501568,  SWAPS);

    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  MEM1,           1,    0,  891481251,     5960878,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  MEM2,           1,    0,  891481251,     5960878,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  MEM3,           1,    0,  891481251,     5960878,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  MEM4,           1,    0,  891481251,     5960878,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  MEM5,           3,    2,  328766946,     3378107,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  LMEM1,          6,    3,  157504935,     2592041,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  LMEM2,         19,    4,   49910289,     2098199,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  LMEM3,        194,    4,    7960268,     1905655,  SWAPS);

    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  LMEM1,          1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  LMEM2,          1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  LMEM3,          1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  LMEM4,          1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  LMEM5,          1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  LMEM6,          2,    1,   29078685,      615926,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  LMEM7,        194,    4,     502032,      484764,  SWAPS);

    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, MINI_PC,      194,    4,   32084148,     6501568,  SWAPS);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  MINI_PC,      194,    4,    7960268,     1905655,  SWAPS);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  MINI_PC,        1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_12K,  MINI_PC,        1,    0,   17622233,      499259,  0);

    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, SMALL_PC,     194,    4,   32084148,     6501568,  SWAPS);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  SMALL_PC,       3,    2,  328766946,     3378107,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  SMALL_PC,       1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_12K,  SMALL_PC,       1,    0,   17622233,      499259,  0);

    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, SMALL_SERVER,   4,    4,  900876010,    10489187,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  SMALL_SERVER,   1,    0,  891481251,     5960878,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  SMALL_SERVER,   1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_12K,  SMALL_SERVER,   1,    0,   17622233,      499259,  0);

    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, MEDIUM_SERVER,  2,    1, 1858375961,    14883962,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  MEDIUM_SERVER,  1,    0,  891481251,     5960878,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  MEDIUM_SERVER,  1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_12K,  MEDIUM_SERVER,  1,    0,   17622233,      499259,  0);

    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, BIG_SERVER,     1,    0, 3593147643UL,  22846293,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  BIG_SERVER,     1,    0,  891481251,     5960878,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  BIG_SERVER,     1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_12K,  BIG_SERVER,     1,    0,   17622233,      499259,  0);

    TEST_DECIDES_PASSES(BP_SILVA_108_PARC, HUGE_SERVER,    1,    0, 3593147643UL,  22846293,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_REF,  HUGE_SERVER,    1,    0,  891481251,     5960878,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_40K,  HUGE_SERVER,    1,    0,   56223289,      740516,  0);
    TEST_DECIDES_PASSES(BP_SILVA_108_12K,  HUGE_SERVER,    1,    0,   17622233,      499259,  0);
}
