...
void TEST_SLOW_PT_FamilyFinder() {
    ...
    test                  = ______RESET;
    test.shortOligo       = true; TEST_EXPECT_RELATIVES(test, "LgtLytic/154/98.08917,AclPleur/139/83.23353,VbhChole/133/84.17722,VblVulni/133/84.17722");
    ...
    test.scaling         = RSS_BOTH_MIN; TEST_EXPECT_RELATIVES(test, "LgtLytic/154/98.71795,AclPleur/139/89.10256,DsssDesu/84/88.42105,CltBotul/95/87.96296");
    ...
    test.scaling         = RSS_SOURCE;   TEST_EXPECT_RELATIVES(test, "LgtLytic/154/98.71795,AclPleur/139/89.10256,VbhChole/133/85.25641,VblVulni/133/85.25641");
    test.partial         = true;
