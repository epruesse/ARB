...
static ED4_objspec fake_object_spec(ED4_P_NO_PROP, ED4_L_FAKE, ED4_L_NO_LEVEL, ED4_L_NO_LEVEL, ED4_L_NO_LEVEL, 0);
...
public:
    fake_base_4test(fake_man_4test *fake_man, const char *seq_, int size_)
        : ED4_base(fake_object_spec, "fake", 0, 0, 0, 0, fake_man),
          seq(seq_),
          size(size_)
    {}
