...
ED4_returncode ED4_cursor::ShowCursor(ED4_index offset_x, ED4_cursor_move move, int move_pos)
{
    ...
    ED4_ROOT->world_to_win_coords(current_aww(), &x_help, &y_help);
...
ED4_returncode ED4_cursor::show_cursor_at(ED4_terminal *target_terminal, ED4_index scr_pos)
{
    ...
    ED4_ROOT->world_to_win_coords(current_aww(), &win_x, &win_y);
        ...
        switch (cursor_move) {
            ...
            case ED4_C_DOWN:
                if (!result) { // don't overwrite (i.e. take first matching terminal)
                    ...
                    if (isScreen) ED4_ROOT->world_to_win_coords(current_aww(), &x, &y); // if current_y is screen, convert x/y to screen-coordinates as well
