 ...
 */
char
genbank_in_locus(FILE_BUFFER fp)
{
 ...
 */
void
genbank_to_genbank(char *inf, char *outf)
{
    FILE        *IFP, *ofp;
    FILE_BUFFER  ifp;
    char         temp[TOKENNUM];
 ...
 */
void
init_reference(Reference *ref, int flag)
{
    /*  char    *Dupstr(); */
