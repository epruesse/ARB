...
DEVEL_DEF=-DDEVEL_RALF -DDEVEL_IDP -DDEVEL_JUERGEN -DDEVEL_MARKUS -DDEVEL_ARTEM -DDEVEL_KAI
endif

ifeq ($(DEVELOPER),HARALDX) # special settings for HARALDX
DEVEL_DEF=-DDEVEL_HARALD -DDEVEL_ARTEM -DDEVEL_KAI
endif
...
ALLOWED_GCC_4xx_VERSIONS=4.0.0 4.0.2 4.0.3 4.1.1 4.1.2
