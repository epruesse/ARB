...
/*    Time-stamp: <Fri Aug/11/2006 10:02 MET Coder@ReallySoft.de>         */
/*                                                                        */
/*                                                                        */
...
GBDATA *GEN_find_pseudo_species(GBDATA *gb_main, const char *organism_name, const char *gene_name, GB_HASH *pseudo_hash) {
    // paramter pseudo_hash :
    // 0 -> use slow direct search
    // otherwise it shall be a hash generated by GEN_create_pseudo_species_hash()
    GBDATA *gb_pseudo;
