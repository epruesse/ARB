...
void gb_write_index_key P_((GBCONTAINER *father, long index, GBQUARK new_index));
void gb_write_key P_((GBDATA *gbd, const char *s));
...
void gb_index_check_out P_((GBDATA *gbd));
