...
gellisary::GAGenomFeatureTableDDBJ::GAGenomFeatureTableDDBJ()
{
...
int gellisary::GAGenomFeatureTableDDBJ::nameToNumberOfFeature(string * source_str)
{
	for(int i = 0; i < (int)features.size();i++)
	{
...
void gellisary::GAGenomFeatureTableDDBJ::parse()
{
	string tmp_str;
	string t_str;
	bool newgene = true;
...
GAGenomFeatureTableSourceDDBJ * gellisary::GAGenomFeatureTableDDBJ::getFeatureTableSource()
{
	if(!prepared)
	{
		parse();
...
string * gellisary::GAGenomFeatureTableDDBJ::getGeneName()
{
	if(!prepared)
	{
		parse();
