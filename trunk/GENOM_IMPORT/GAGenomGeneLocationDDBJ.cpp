...
gellisary::GAGenomGeneLocationDDBJ::GAGenomGeneLocationDDBJ()
{
	pointer = false;
	current_value = -1;
}
 ...
 * 'optimieren'.
 */
void gellisary::GAGenomGeneLocationDDBJ::parse(string * location)
{
	...
	if(has_comma)
	{
		...
		{
			tmp_location = new GAGenomGeneLocationDDBJ;
			t2_str = tvector[k];
