...
void SEC_helix_strand::update(double fixpoint_x_, double fixpoint_y_, double angle_difference) {
    ...
    if (angle_difference != 0) {
        ...
        //        root->setRootAngle(new_angle); //letsplay
    }
...
void SEC_segment::paint(AW_device *device, SEC_helix_strand *previous_strand_pointer) {
    ...
    if(lastSearchColor){
        ...
        device->text(SEC_GC_HELIX, helixEndBase, start_x, start_y, 0.5, root->helix_filter,(AW_CL)((SEC_Base *)previous_strand_pointer),abs_pos,0 );
	    lastSearchColor = 0;
    }
