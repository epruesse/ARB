...
{ 
  int 
    numberOfModels = tr->NumberOfModels;
 double 
   *ext_EIGN,
   *EV,
   *EI,
 ...
 switch(/*tr->dataType[model]*/ tr->partitionData[model].dataType)
   ...
   case AA_DATA:       
       ...
       if(adef->useMultipleModel)
	 {
	   if(adef->proteinMatrix == GTR)
	     ...
	     {	     
	       /*initProtMat(model, f, adef->protModels[model], ext_initialRates);*/
	       initProtMat(model, f, tr->partitionData[model].protModels, ext_initialRates);
	       
	       if(tr->partitionData[model].protFreqs)
		 /*adef->protFreqs[model]*/
		 {	     	      
		   for(l = 0; l < 20; l++)		
       ...
       else
	 {
	   if(adef->proteinMatrix == GTR)
	     ...
	     {	  
	       initProtMat(model, f, adef->proteinMatrix, ext_initialRates);
       ...
       for (j = 0; j < 20; j++) 
	 {
       ...
       /* TODO MULT SOSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
	 ...
	 for (k = 0; k< 20; k++)
       ...
       if(numberOfModels == 1)    
	 *fracchange = fracchanges[model];
         
       /*TODO MULT SOSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
   ...
   case DNA_DATA:
       ...
       for (j = 0; j < 4; j++) 
	 {
       ...
       /* TODO MULT SOSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
	 ...
	 for (k = 0; k<4; k++)
       ...
       /*printf("Fracchange model %d : %f\n", model,  fracchanges[model]);*/
