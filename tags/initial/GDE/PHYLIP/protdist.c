...
boolean         weights, printdata, progress, mulsets, interleaved, ibmpc,
                vt52, ansi, basesequal, usepam, kimura, firstset;
codetype        whichcode;
cattype         whichcat;
steparray       weight;
Char          **nayme;
...
void 
givens(a, i, j, n, ctheta, stheta, left)
	double          (*a)[20];
	long            i, j, n;
...
main(argc, argv)
	int             argc;
	Char           *argv[];
{				/* ML Protein distances by PAM or categories
				 * model */
