...
*/
	...
	if(file == NULL)
	    Error(
		"ARB_GDEmenus file not in the home, local, or $ARBHOME/GDEHELP directory");
...
*/
		...
		else if(Find(in_line,"arg:"))
		{
			...
			if(curarg == 0)
				...
				resize = (char *)realloc((char *)thisitem->arg,
...
*/
		else if(Find(in_line,"argtype:"))
		{
			...
			else if(strcmp(temp,"tree")==0)
				thisarg->type=CHOICE_TREE;
			else if(strcmp(temp,"sai")==0)
				thisarg->type=CHOICE_SAI;
			else if(strcmp(temp,"weights")==0)
				thisarg->type=CHOICE_WEIGHTS;
...
*/
		else if(Find(in_line,"argchoice:"))
		{
			...
			if(curchoice == 0)
				...
				resize = (char *)realloc((char *)thisarg->choice,
...
*/
		else if(Find(in_line,"in:"))
		{
			...
			if(curinput == 0)
				...
				resize = (char *)realloc((char *)thisitem->input,
...
*/
		...
		else if(Find(in_line,"out:"))
		{
			...
			if(curoutput == 0)
				...
				resize = (char *)realloc((char *)thisitem->output,
		...
		{
			if(thisinput == NULL)
				Error("Problem with $ARBHOME/GDEHELP/ARB_GDEmenus");
