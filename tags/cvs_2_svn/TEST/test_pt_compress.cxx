...
void gap_compress::optimize(void) {
    ...
    masters = (master_gap_compress **)realloc((char *)masters,sizeof(master_gap_compress) * nmasters);
    memmasters = nmasters;
    clients = (client_gap_compress **)realloc((char *)clients,sizeof(client_gap_compress) * nclients);
    memclients = nclients;
}
