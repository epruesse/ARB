...
public:
	...
	void 		kernighan_rek(int rek_deep,int *rek_breite,
				      int rek_breite_anz,const int rek_deep_max,
				      ...
				      AP_KL_FLAG searchflag,AP_BOOL *abbruch_flag);
    ...
    int	indexOf(const AP_tree_edge *e) const 
	    { int i; for (i=0; i<3; i++) if (edge[i]==e) return i;return -1; }
    ...
    void linkAllEdges(AP_tree_edge *edge1, 
		      AP_tree_edge *edge2, 
		      AP_tree_edge *edge3);
    
    void unlinkAllEdges(AP_tree_edge **edgePtr1, 
